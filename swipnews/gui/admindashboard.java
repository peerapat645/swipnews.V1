...
public class admindashboard extends popup implements MouseListener {
    ...
    private void loadNewsFromCSV(String filePath) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            JOptionPane.showMessageDialog(this, "ไม่พบไฟล์ข่าว: " + filePath, "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void removeNewsFromCSV(String newsToRemove) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(inputFile));
            ...
            JOptionPane.showMessageDialog(this, "เกิดข้อผิดพลาดในการลบข่าว", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // แทนที่ไฟล์เก่า
        if (!inputFile.delete() || !tempFile.renameTo(inputFile)) {
            JOptionPane.showMessageDialog(this, "ไม่สามารถอัปเดตไฟล์ข่าวได้", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
        ...
        for (int i = 0; i < deleteIcons.size(); i++) {
            if (e.getSource() == deleteIcons.get(i)) {
                ...
                int confirm = JOptionPane.showConfirmDialog(this,
                        "ต้องการลบข่าว \"" + delTitle + "\" หรือไม่?",
                        "ยืนยันการลบ",
