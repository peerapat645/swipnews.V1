...
public class login extends popup implements MouseListener{
    ...
    public login() {
        ...
        showePassword.setBounds(100, 240, 200, 30); // x, y, width, height
        imageLabelUser.setBounds(60, 150, 30, 30); // x, y, width, height
        imageLabelLock.setBounds(60, 200, 30, 30); // x, y, width, height
        ...
        label_wallcome.setBounds(100, 90, 300, 80); // x, y, width, height
